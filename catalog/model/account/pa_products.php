 ...
 */
class ModelAccountPaProducts extends Model {
  // __constructer
  ...
  public function delete($quote_id) {
    $this->db->query("DELETE FROM `" . DB_PREFIX . "customeralert_products` WHERE `quote_id` = " . (int)$quote_id . " AND customer_id = '".(int)$this->customer->getId()."'");
  }
