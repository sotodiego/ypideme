...
$_['entry_analytic_pages']      = "Google Analytics Allowed pages";
$_['help_analytic_pages']       = "Only these allowed pages will be track on Google Analytics";
$_['entry_seller_profile']      = "Seller Profile";
$_['entry_seller_collection']   = "Seller Collection";
$_['entry_seller_product']      = "Seller Product";
$_['entry_seller_analytic']     = "Allow Seller to add Google Analytic";
$_['help_seller_analytic']      = "If this option is enabled only then seller will be able to add Google Analtyic id";
...
$_['entry_seller_create_order']         = "Seller can create orders";
$_['entry_seller_create_order_info']    = "If it is enabled then seller can create order on behalf of selected customer!";
...
$_['entry_mod_membership_quote']                  = 'Quote For Membership';
...
//mail tab
$_['entry_order_status_change_mail']  		          = 'Mail To Admin After order status changes';
