...
class ControllerCustomerpartnerCommission extends Controller {
	...
	private function validate() {
		...
		if (isset($this->request->post['fixed'])) {
			if(!is_numeric($this->request->post['fixed']) || $this->request->post['fixed'] < 0){
				$this->error['warning'] = $this->language->get('error_fixed');
			}
		}

		if (isset($this->request->post['percentage'])) {
			if(!is_numeric($this->request->post['percentage']) || $this->request->post['percentage'] < 0){
				$this->error['warning'] = $this->language->get('error_percentage');
			}
		}
