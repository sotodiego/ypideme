...
class ControllerCustomerpartnerReview extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getList($data) {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('customerpartner/review/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('customerpartner/review/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$data['sort_seller'] = $this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . '&sort=c2f.seller_id' . $url, true);
		$data['sort_customer'] = $this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . '&sort=c2f.customer_id' . $url, true);
		$data['sort_status'] = $this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . '&sort=c2f.status' . $url, true);
		$data['sort_createdate'] = $this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . '&sort=c2f.createdate' . $url, true);
		...
		$pagination->url = $this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('customerpartner/review_list', $data));
	}
	...
	protected function getForm($data) {
		...
		if (!isset($this->request->get['review_id'])) {
			$data['action'] = $this->url->link('customerpartner/review/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('customerpartner/review/edit', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $this->request->get['review_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('customerpartner/review', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('customerpartner/review_form', $data));
	}
